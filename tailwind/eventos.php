...
<body>
    ...
    <div class="max-w-7xl mx-auto relative">
        ...
        <img class="w-full h-auto max-h-[350px] object-cover object-center" src="imgs/imagem3.jpg" alt="evento em destaque">
    </div>
    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="">
                <img class="w-full h-auto" src="imgs/imagem1_min.jpg" alt="Evento 1">
            ...
            <div class="">
                <img class="w-full h-auto" src="imgs/imagem2_min.jpg" alt="Evento 2">
            ...
            <div class="">
                <img class="w-full h-auto" src="imgs/imagem4_min.jpg" alt="Evento 4">
